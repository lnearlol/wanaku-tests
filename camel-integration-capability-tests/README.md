...
|-------|-------|---------|-------------|
| `CamelBasicToolITCase` | 8 | simple-tool/ | Register, invoke, params, explicit mapping, DataStore, isolation |
| `CamelFileResourceITCase` | 6 | file-resource/ | List, read, REST API, non-existent file, DataStore, isolation |
